...
import com.yugahashimoto.androidcode.MainActivity
...
class LocalRuntimeService : Service() {
    ...
    override fun onCreate() {
        super.onCreate()
        manager = (application as AndroidCodeApplication).localRuntimeManager
        createChannel()
    ...
    companion object {
        ...
        const val ACTION_INSTALL_AND_START = "com.yugahashimoto.androidcode.local.INSTALL_AND_START"
        const val ACTION_START = "com.yugahashimoto.androidcode.local.START"
        const val ACTION_STOP = "com.yugahashimoto.androidcode.local.STOP"
        const val ACTION_REINSTALL = "com.yugahashimoto.androidcode.local.REINSTALL"
        const val ACTION_UPDATE = "com.yugahashimoto.androidcode.local.UPDATE"
        const val ACTION_ROLLBACK = "com.yugahashimoto.androidcode.local.ROLLBACK"
        const val ACTION_DELETE = "com.yugahashimoto.androidcode.local.DELETE"

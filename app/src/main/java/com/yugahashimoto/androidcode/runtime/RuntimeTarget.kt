...
interface RuntimeConnectionStore {
    ...
    fun connections(): List<com.yugahashimoto.androidcode.data.connection.ConnectionProfile>

    fun upsertConnection(profile: com.yugahashimoto.androidcode.data.connection.ConnectionProfile)

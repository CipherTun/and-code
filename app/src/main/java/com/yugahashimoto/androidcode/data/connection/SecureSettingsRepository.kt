package com.yugahashimoto.androidcode.data.connection

import android.content.Context
import android.content.SharedPreferences
import androidx.security.crypto.EncryptedSharedPreferences
import androidx.security.crypto.MasterKey
import com.yugahashimoto.androidcode.data.repository.UnreadSessionStore
        ...
        set(value) {
            preferences.edit()
                .putString(
                    ...
                    com.yugahashimoto.androidcode.runtime.local.LocalProviderCredentialStore.encodeMap(value),
                )
                .apply()
        }

    fun providerApiKeys(): Map<String, String> =
        com.yugahashimoto.androidcode.runtime.local.LocalProviderCredentialStore.decodeMap(

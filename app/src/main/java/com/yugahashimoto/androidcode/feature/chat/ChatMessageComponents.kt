...
import com.yugahashimoto.androidcode.ui.theme.AndroidCodeWarning
...
fun PermissionCard(
    ...
    Card(
        colors = CardDefaults.cardColors(containerColor = AndroidCodeWarning.copy(alpha = 0.10f)),
        ...
        Column(
            ...
            Row(verticalAlignment = Alignment.CenterVertically) {
                Icon(Icons.Default.Security, contentDescription = stringResource(R.string.cd_permission), tint = AndroidCodeWarning)

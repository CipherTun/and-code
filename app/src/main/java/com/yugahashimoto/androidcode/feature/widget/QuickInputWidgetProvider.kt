package com.yugahashimoto.androidcode.feature.widget
...
class QuickInputWidgetProvider : AppWidgetProvider() {
    ...
    companion object {
        const val ACTION_SEND = "com.yugahashimoto.androidcode.widget.SEND"
        const val ACTION_MIC = "com.yugahashimoto.androidcode.widget.MIC"

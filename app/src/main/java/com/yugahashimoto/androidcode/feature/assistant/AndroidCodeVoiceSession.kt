...
class AndroidCodeVoiceSession(context: Context) :
    ...
    private val app = context.applicationContext as AndroidCodeApplication
    ...
    override fun onCreateContentView(): View =
        ComposeView(context).apply {
            setViewTreeLifecycleOwner(this@AndroidCodeVoiceSession)
            setViewTreeSavedStateRegistryOwner(this@AndroidCodeVoiceSession)
            setViewTreeViewModelStoreOwner(this@AndroidCodeVoiceSession)
            setContent {
                AndroidCodeTheme {
    ...
    Column(
        ...
        Row(modifier = Modifier.fillMaxWidth(), verticalAlignment = Alignment.CenterVertically) {
            Column(modifier = Modifier.weight(1f)) {
                Text("AndroidCode", style = MaterialTheme.typography.titleLarge, fontWeight = FontWeight.SemiBold)

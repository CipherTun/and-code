...
class AndroidCodeVoiceInteractionService : VoiceInteractionService() {
    ...
    companion object {
        ...
        const val ACTION_SHOW_ASSISTANT = "com.yugahashimoto.androidcode.action.SHOW_ASSISTANT"

        fun show(context: Context) {
            context.startService(
                Intent(context, AndroidCodeVoiceInteractionService::class.java).apply {

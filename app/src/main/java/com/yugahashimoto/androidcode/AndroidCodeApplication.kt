package com.yugahashimoto.androidcode
...
import com.yugahashimoto.androidcode.core.notification.RuntimeNotificationHelper
import com.yugahashimoto.androidcode.data.connection.SecureSettingsRepository
import com.yugahashimoto.androidcode.data.repository.ProviderCatalogCache
import com.yugahashimoto.androidcode.data.repository.RuntimeActivityRepository
import com.yugahashimoto.androidcode.data.repository.RuntimeCatalogRepository
import com.yugahashimoto.androidcode.data.settings.AppPreferencesRepository
import com.yugahashimoto.androidcode.di.appModule
import com.yugahashimoto.androidcode.di.viewModelModule
import com.yugahashimoto.androidcode.feature.support.GitHubStarCoordinator
import com.yugahashimoto.androidcode.feature.support.GitHubStarService
import com.yugahashimoto.androidcode.runtime.RuntimeRegistry
import com.yugahashimoto.androidcode.runtime.local.AdbConnectionManager
import com.yugahashimoto.androidcode.runtime.local.AndroidClaudeMessages
import com.yugahashimoto.androidcode.runtime.local.AndroidLocalRuntimeMessages
import com.yugahashimoto.androidcode.runtime.local.ClaudeCodeController
import com.yugahashimoto.androidcode.runtime.local.ClaudeCodeRuntime
import com.yugahashimoto.androidcode.runtime.local.ClaudeCodeTarget
import com.yugahashimoto.androidcode.runtime.local.DefaultLocalRuntimeUpdateEngine
import com.yugahashimoto.androidcode.runtime.local.GitCloneRepository
import com.yugahashimoto.androidcode.runtime.local.GitCredentialHelper
import com.yugahashimoto.androidcode.runtime.local.LocalProviderCredentialStore
import com.yugahashimoto.androidcode.runtime.local.LocalRuntimeAccessCoordinator
import com.yugahashimoto.androidcode.runtime.local.LocalRuntimeCommandRunner
import com.yugahashimoto.androidcode.runtime.local.LocalRuntimeDiagnosticsCollector
import com.yugahashimoto.androidcode.runtime.local.LocalRuntimeInstaller
import com.yugahashimoto.androidcode.runtime.local.LocalRuntimeManager
import com.yugahashimoto.androidcode.runtime.local.LocalRuntimeMessages
import com.yugahashimoto.androidcode.runtime.local.LocalRuntimeProcessLauncher
import com.yugahashimoto.androidcode.runtime.local.LocalRuntimeReleaseClient
import com.yugahashimoto.androidcode.runtime.local.LocalRuntimeServiceController
import com.yugahashimoto.androidcode.runtime.local.LocalRuntimeTarget
import com.yugahashimoto.androidcode.runtime.local.LocalRuntimeUpdater
import com.yugahashimoto.androidcode.runtime.local.VerifiedRuntimeDownloader
import com.yugahashimoto.androidcode.startup.CatalogReconcileInitializer
import com.yugahashimoto.androidcode.startup.RuntimeAutoStartInitializer
...
class AndroidCodeApplication : Application() {
    ...
    override fun onCreate() {
        super.onCreate()
        startKoin {
            androidContext(this@AndroidCodeApplication)

package com.yugahashimoto.androidcode.core.notification
...
class RuntimeNotificationHelper(private val context: Context) {
    ...
    companion object {
        ...
        const val ACTION_PERMISSION_RESPONSE = "com.yugahashimoto.androidcode.PERMISSION_RESPONSE"
        const val EXTRA_OPEN_ACTIVITY = "open_activity"
        const val EXTRA_OPEN_CHAT = "open_chat"
        const val EXTRA_SESSION_ID = "session_id"

        /** The key [com.yugahashimoto.androidcode.MainActivity] reads to jump straight to a session. */

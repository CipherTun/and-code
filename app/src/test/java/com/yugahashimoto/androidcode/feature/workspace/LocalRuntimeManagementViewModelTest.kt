...
import com.yugahashimoto.androidcode.runtime.local.AdbConnectionState
import com.yugahashimoto.androidcode.runtime.local.LocalRuntimeDiagnostics
import com.yugahashimoto.androidcode.runtime.local.LocalRuntimeOperationResult
import com.yugahashimoto.androidcode.runtime.local.LocalRuntimeProcessMetrics
import com.yugahashimoto.androidcode.runtime.local.LocalRuntimeRelease
import com.yugahashimoto.androidcode.runtime.local.LocalRuntimeReleaseAsset
import com.yugahashimoto.androidcode.runtime.local.LocalRuntimeUpdateCheck
...
class LocalRuntimeManagementViewModelTest {
    ...
    @Test
    fun `initial load collects diagnostics update state and rollback target`() =
        runTest(dispatcher) {
    ...
    @Test
    fun `update check failure keeps diagnostics and exposes update error`() =
        runTest(dispatcher) {
            val runtimeState = MutableStateFlow<LocalRuntimeStatus>(LocalRuntimeStatus.Ready("1.18.3", 4097))
            val viewModel =
                viewModel(

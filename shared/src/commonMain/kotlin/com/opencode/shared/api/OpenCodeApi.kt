...
interface OpenCodeApi {
    ...
    suspend fun readFile(path: String, sessionId: String? = null): OpenCodeFileContent
    suspend fun searchFiles(sessionId: String, pattern: String): List<OpenCodeSearchMatch>
    suspend fun listFileChanges(sessionId: String): List<OpenCodeFileChange>
    suspend fun revertFileChange(sessionId: String, path: String)
    suspend fun respondPermission(id: String, approved: Boolean)
    suspend fun respondQuestion(id: String, answers: List<String>)
